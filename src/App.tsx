...
import type { CoachTableMetrics } from './types/golf'
  ...
  return (
    <div className="app">
      ...
      <main className={`main ${!isLoading && !error ? 'main-with-sidebar' : ''} ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
        ...
        {!isLoading && !error && activeTab !== 'tiger5' && activeTab !== 'sg' && activeTab !== 'driving' && activeTab !== 'approach' && activeTab !== 'putting' && activeTab !== 'scoring' && activeTab !== 'path' && activeTab !== 'shortgame' && activeTab !== 'coaching' && (
...
/**
 * Coaching View - Pivot table with players as rows and metrics as columns
 * Features:
 * - Sortable columns
 * - Radio buttons: Avg/Per Round vs Total
 * - Radio buttons: Value vs Rank
 */
function CoachingView({ metrics }: { metrics: CoachTableMetrics }) {
