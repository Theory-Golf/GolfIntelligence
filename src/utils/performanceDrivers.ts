...
import type { ProcessedShot, Tiger5Metrics, MentalMetrics, BirdieAndBogeyMetrics, DrivingMetrics, ProblemDriveMetrics, ApproachMetrics, ApproachDistanceBucket, ShortGameMetrics, PuttingMetrics, PuttingDistanceBucket, PerformanceDriver, PerformanceDriverSegment, PerformanceDriverRating, PerformanceDriversResult } from '../types/golf';
