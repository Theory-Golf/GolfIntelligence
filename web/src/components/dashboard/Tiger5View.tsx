 ...
 */
export function Tiger5View({ metrics, lastUpdated }: { metrics: Tiger5Metrics; lastUpdated: Date | null }) {
...
/**
 * Root Cause Section - Summary view of root causes across all Tiger 5 fail holes
